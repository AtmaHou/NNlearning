...
class SoftmaxModel(Model):
    ...
    def add_placeholders(self):
        ...
        """
        ### YOUR CODE HERE
        self.x = tf.placeholder(tf.float32, (Config.batch_size, Config.n_features))
        self.labels = tf.placeholder(tf.float32, (Config.batch_size, Config.n_classes))
        ### END YOUR CODE
    ...
    def add_prediction_op(self):
        ...
        """
        ### YOUR CODE HERE
        self.w = tf.Variable(tf.zeros((Config.n_features, Config.n_classes), dtype=tf.float32))
        self.b = tf.Variable(tf.zeros((Config.batch_size, Config.n_classes), dtype=tf.float32))
        pred = softmax(tf.matmul(self.x, self.w) + self.b)
        ### END YOUR CODE
        return pred
